  ...
  methods: {
    ...
    getIconByMuscleGroup: (mGroup) => {
      switch(mGroup.toLowerCase()) {
        case "legs": return 'mdi-snowman';
        case "hands": return 'mdi-arm-flex';
        case "shoulders": return 'mdi-weight-lifter';
        case "back": return 'mdi-human-handsup';
        case "chest": return 'mdi-treasure-chest';
    ...
    getCaptionMuscleGroup: (mGroup) => {
      switch(mGroup.toLowerCase()) {
        ...
        default: return 'Неопределенная группа мышц';
      }
    },
    applySelectFilter() {
